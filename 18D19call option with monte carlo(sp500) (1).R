...
######################################################################################Metrhod I
call.hn<-HNGOption(TypeFlag = "c", model= mle$model,S=255, X=260, Time.inDays=63, r.daily=0.05/252)
...
call2<-rep(0, 10000)
for(i in 1:10000){
  call2[i]<-callMonte.function(0.05, 255,sigma2*sqrt(252) , 63/252, 260)
}
...
call3<-rep(0, 10000)
for(i in 1:10000){
  call3[i]<-callMonte.function(0.05, 255, mean.sigma.nnetar*sqrt(252) , 63/252, 260)
}
